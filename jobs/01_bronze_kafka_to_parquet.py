...
# S3 file path
BRONZE_PATH = "s3a://clickstream-event-data/bronze/"
CHECKPOINT_PATH = "s3a://clickstream-event-data/checkpoints/bronze"
...
clicks_schema = StructType([
    ...
    StructField('ad_id', IntegerType()),
    StructField('join_key', LongType()),
    StructField('impression_event_id', StringType()),
...
conversions_schema = StructType([
    ...
    StructField('ad_id', IntegerType()),
    StructField('join_key', LongType()),
    StructField('click_event_id', StringType()),
